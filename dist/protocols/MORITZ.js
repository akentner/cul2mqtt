...
var MORITZ = function (_AbstractProtocolHand) {
    _inherits(MORITZ, _AbstractProtocolHand);

    function MORITZ() {
        _classCallCheck(this, MORITZ);

        return _possibleConstructorReturn(this, (MORITZ.__proto__ || Object.getPrototypeOf(MORITZ)).apply(this, arguments));
    }
